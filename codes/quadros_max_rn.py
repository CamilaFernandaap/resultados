...
RASTER_1990 = r"C:\Users\camil\Downloads\mapbiomas\RN_1990_lclu_recortado.tif"
RASTER_2020 = r"C:\Users\camil\Downloads\mapbiomas\RN_2020_lclu_recortado.tif"
SHAPEFILE_GRADE = "grade_analise_RN.shp"

# Pasta de saída
OUTPUT_DIR = r"F:\validacoes\resultados"

# Classe de interesse
CLASSE_FLORESTA = 4  # Formação SAVÂINCA
...
def plot_evolucao_cobertura_vegetal(blocos_info, df_cobertura, classe_nome='Formação Savânica'):
    """
    ...
    plt.tight_layout()
    output_file = os.path.join(OUTPUT_DIR, 'evolucao_cobertura_vegetal_rn.png')
...
def plot_mapa_blocos_extremos(blocos_info, df_cobertura, grade, classe_nome='Formação Savânica'):
    """
    ...
    plt.tight_layout()
    output_file = os.path.join(OUTPUT_DIR, 'mapa_blocos_extremos_rn.png')
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("ANÁLISE DE EVOLUÇÃO DA COBERTURA VEGETAL - RN")
    ...
    rasters_disponiveis = {
        1990: RASTER_1990,
        2020: RASTER_2020,
        2000: r"C:\Users\camil\Downloads\mapbiomas\RN_2000_lclu_recortado.tif",
        2010: r"C:\Users\camil\Downloads\mapbiomas\RN_2010_lclu_recortado.tif",
    }
    ...
    plot_evolucao_cobertura_vegetal(blocos_info, df_cobertura, classe_nome='Formação Savânica')
    plot_mapa_blocos_extremos(blocos_info, df_cobertura, grade, classe_nome='Formação Savânica')
    
    print("\n" + "="*80)
    print("ANÁLISE CONCLUÍDA!")
    print("="*80)
    print(f"\nArquivos gerados em: {OUTPUT_DIR}")
    print(f"  - dados_cobertura_vegetal_rn.csv")
    print(f"  - evolucao_cobertura_vegetal_rn.png")
    print(f"  - mapa_blocos_extremos_rn.png")
