...
if __name__ == "__main__":
    ...
    plot_mapas_tendencia(
        ...
        shp_uf,
        "SP",
        "Tendências Sazonais de Precipitação – São Paulo (1990–2024)",
        "mm/década",
        "BrBG",
        limites_prec,
        os.path.join(out_dir, "prec_tendencia_sazonal_decadal_sp.png")
    )
    ...
    plot_mapas_tendencia(
        ...
        shp_uf,
        "SP",
        "Tendências Sazonais de Radiação – São Paulo (1990–2024)",
        "W/m²/década",
        "YlOrBr",
        limites_rad,
        os.path.join(out_dir, "rad_tendencia_sazonal_decadal_sp.png")
    )
    ...
    plot_mapas_tendencia(
        ...
        shp_uf,
        "SP",
        "Tendências Sazonais de Temperatura – São Paulo (1990–2024)",
        "°C/década",
        "RdBu_r",
        limites_temp,
        os.path.join(out_dir, "temp_tendencia_sazonal_decadal_sp.png")
    )
